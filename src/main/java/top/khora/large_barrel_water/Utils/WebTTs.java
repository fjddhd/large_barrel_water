 ...
 * 
 */
 package top.khora.large_barrel_water.Utils;
...
public class WebTTs {
	...
	private static final String APPID = "5d19804e";
	// 接口密钥（webapi类型应用开通合成服务后，控制台--我的应用---语音合成---相应服务的apikey）
	private static final String API_KEY = "b1dc611dacaff4caf187c9b4ebc77a8a";
	// 待合成文本
	private static final String TEXT = "我的第一条测试信息";
	...
	private static final String VOICE_NAME = "x_binge";
	// 引擎类型
